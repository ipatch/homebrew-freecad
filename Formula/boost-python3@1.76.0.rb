class BoostPython3AT1760 < Formula
  desc "C++ library for C++/Python3 interoperability"
   ...
   def install
     ...
     pyver = Language::Python.major_minor_version Formula["./python@3.9.7"].opt_bin/"python3"
     py_prefix = Formula["./python@3.9.7"].opt_frameworks/"Python.framework/Versions/#{pyver}"
     py_prefix = Formula["./python@3.9.7"].opt_prefix if OS.linux?
