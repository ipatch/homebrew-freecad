class PythonTkAT397 < Formula
  ...
  def install
    cd "Modules" do
      ...
      EOS
      system Formula["./python@3.9.7"].bin/"python3", *Language::Python.setup_install_args(libexec),
                                                  "--install-lib=#{libexec}"
  ...
  test do
    system Formula["./python@3.9.7"].bin/"python3", "-c", "import tkinter"
    ...
    system Formula["./python@3.9.7"].bin/"python3", "-c", "import tkinter; root = tkinter.Tk()"
  end
end